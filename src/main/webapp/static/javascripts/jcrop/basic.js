$("body").append('<input type="hidden" id="x"/>');
$("body").append('<input type="hidden" id="y"/>');
$("body").append('<input type="hidden" id="w"/>');
$("body").append('<input type="hidden" id="h"/>');
$(function(){
    //默认图像居中显示
...
function imgRotate(deg){
    ...
    if($.support == 8.0 || $.support == 7.0 || $.support == 6.0 ){
...
function imgToSize(size) {
    ...
    if(($.support == 8.0 || $.support == 7.0 || $.support == 6.0) && (_data == 90 || _data == 270)){

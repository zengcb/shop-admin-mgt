                ...
                onOptClick: function (li) {
                    ...
                    li.click(function () {
                        ...
                        if(settings.isSingle){
                        	if(li.parents(".group").find('li.selected').length>0){
                        		var brothers=li.parents(".group").find('li.selected');
                        		brothers.each(function(e){
                        			$(this).data('opt')[0].selected=false;
                        			$(this).removeClass("selected");
                        		});
                        		O.selAllState();
                        	}
                        	
                        	//O.unSelectItem(selectVal);
                        }
                        if (O.is_multi) {
